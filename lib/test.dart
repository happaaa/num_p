...
void newtest() {
  ...
  group("Arithmetic operations:", () {
    ...
    group("Addition:", () {
      ...
      test("D + E", () {
        expect((D + E).val, equals([false, [123456, 789987654321123, 456789987654321], [739048321636433, 173459656000000]]));
      });
      test("E + F", () {
        expect((E + F).val, equals([false, [123456, 789864197532000, 000000000000000], [60035778018622, 765538866001234, 567900000000000]]));
      });
      test("F + G", () {
        print((F + G).val);
        expect((F + G).val, equals([true, [123456789123, 456789987654321], [123456987654321, 123456789998765, 432100000000000]]));
                                   //[true, [123456789123, 456789987654321], [123456987654321, 123456789998765, 432100000000000]]
